...
#import "DaDaPushConfiguration.h"
 ...
 */
extern NSString *const DaDaPushResponseObjectErrorKey;


@interface DaDaPushApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<DaDaPushConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<DaDaPushResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<DaDaPushSanitizer> sanitizer;
