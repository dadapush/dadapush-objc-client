...
#import "DaDaPushBasicAuthTokenProvider.h"
#import "DaDaPushLogger.h"

@interface DaDaPushDefaultConfiguration ()
...
@implementation DaDaPushDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static DaDaPushDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        ...
        _logger = [DaDaPushLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [DaDaPushBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
