...
static NSString * const kDaDaPushAPIVersion = @"1.0.0";

@protocol DaDaPushConfiguration <NSObject>

/**
 * Api logger
 */
@property (readonly, nonatomic) DaDaPushLogger *logger;
