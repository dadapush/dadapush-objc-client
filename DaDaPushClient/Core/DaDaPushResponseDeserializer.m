#import "DaDaPushResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const DaDaPushDeserializationErrorDomainKey = @"DaDaPushDeserializationErrorDomainKey";

NSInteger const DaDaPushTypeMismatchErrorCode = 143553;

NSInteger const DaDaPushEmptyValueOccurredErrorCode = 143509;

NSInteger const DaDaPushUnknownResponseObjectErrorCode = 143528;


@interface DaDaPushResponseDeserializer ()
...
@implementation DaDaPushResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DaDaPushDeserializationErrorDomainKey code:DaDaPushTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DaDaPushDeserializationErrorDomainKey code:DaDaPushEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DaDaPushDeserializationErrorDomainKey code:DaDaPushUnknownResponseObjectErrorCode userInfo:userInfo];
}
